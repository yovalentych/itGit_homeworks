...
function f7() {
  ...
  let power = +document.querySelector('.i-72').value;

  document.querySelector('.out-7').textContent = num ** power;
}
...
function f13() {
  document.querySelector('.out-13').innerHTML = typeof i130.value; //всі інпути це строки
}
...
function f14() {
  ...
  let opperation = document.querySelector('.s-143').value;
  let res = document.querySelector('.out-14');
...
function f15() {
  ...
  let opperator = document.querySelector('.s-153').value;
  let res = document.querySelector('.out-15');
