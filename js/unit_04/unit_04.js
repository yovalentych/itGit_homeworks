...
function f5() {
  ...
  if (chBox.checked) {
    output.textContent = chBox.value;
  } else {
    output.textContent = 'false';
  }
}
...
function f6() {
  let chBox = document.querySelector('.i-6');
...
function f7() {
  ...
  output1.textContent = pass.value;
...
function f13() {
  let rate = document.querySelector('.i-13');
...
function f15() {
  let text = document.querySelector('.i-15');
  let outputA = document.querySelector('.t-15');
  let output = document.querySelector('.out-15');

  outputA.value = text.value;
  output.textContent = text.value;
}
...
function f19() {
  let text = document.querySelector('.out-19');
  let inp = document.querySelector('.i-19');

  console.log(text);
  inp.value = text.innerHTML;
}
...
function f20() {
  let sel_1 = document.querySelector('.s-201');
  let sel_2 = document.querySelector('.s-202');

  sel_2.value = sel_1.value;
}
