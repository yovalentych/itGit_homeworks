...
function f1() {
  let outBlock = document.querySelector('.out-1');

  outBlock.style.width = '200px';
  outBlock.style.height = '90px';
}
...
function f2() {
  let outBlock = document.querySelector('.out-2');

  outBlock.classList.add('bg-orange');
}
...
function f3() {
  let outBlock = document.querySelector('.out-3');

  outBlock.classList.remove('bg-orange');
}
...
function f4() {
  let outBlock = document.querySelector('.out-4');

  outBlock.classList.toggle('bg-orange');
}
...
function f5() {
  let outBlock = document.querySelector('.out-5');

  if (document.querySelector('.out-4').classList.contains('bg-orange')) {
    outBlock.textContent = true;
  } else {
    outBlock.textContent = false;
  }
}
...
function f11() {
  ...
  output.append((newDiv.innerHTML = 25));
}
...
function f12() {
  ...
  output.append((newDiv.innerHTML = 12));
}
...
function f17() {
  let newDiv = document.createElement('div');
  let output = document.querySelector('.out-17');

  newDiv.innerHTML = '14';
  newDiv.classList.add('bg-orange');
  output.replaceWith(newDiv);
}
...
function f18() {
  ...
  output.innerHTML = document.querySelector('.p-18').getAttribute('data-b');
}
...
function f19() {
  ...
  let attr = document.querySelectorAll('.p-19');
  let out = '';
  for (let i = 0; i < attr.length; i++) {
    out += `${attr[i].getAttribute('data-b')} `;
  }
