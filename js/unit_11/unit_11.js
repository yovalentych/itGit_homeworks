...
function f8() {
  ...
  d8.length = 0;
  d8.push(inp);
  for (let k = 0; k < arr_temp.length; k++) {
    d8.push(arr_temp[k]);
  }
...
function f11() {
  ...
  out.innerHTML = d11.indexOf(Number(inp));
}
...
function f15() {
  let inp = Number(document.querySelector('.i-15').value);
