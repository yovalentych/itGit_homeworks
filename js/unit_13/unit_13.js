...
function f6() {
  let key_inp = document.querySelector('.i-61').value;
  let val_inp = document.querySelector('.i-62').value;
...
function f7() {
  let key_inp = document.querySelector('.i-7').value;
  let out = document.querySelector('.out-7');
  if (a7.hasOwnProperty(key_inp)) {
    out.textContent = 1;
  } else {
    out.textContent = 0;
  }
...
function f8() {
  let key_inp = document.querySelector('.i-8').value;
  let out = document.querySelector('.out-8');

  if (a8.hasOwnProperty(key_inp)) {
    out.textContent = a8[key_inp];
  } else {
    out.textContent = 0;
  }
}
...
function f9() {
  let val_inp = document.querySelector('.i-9').value;
...
function f11() {
  let key_inp = document.querySelector('.i-11').value;
  for (key in a11) {
    if (key == key_inp) {
      delete a11[key];
    }
...
function f12() {
  let val_inp = document.querySelector('.i-12').value;
  for (key in a12) {
    if (a12[key] == val_inp) {
      delete a12[key];
    }
...
function f18() {
  let key_inp = document.querySelector('.i-18').value;
  let out = '';
  for (key in a18) {
    if (key == key_inp) {
      for (item in a18[key]) {
...
function f19() {
  let val_inp = document.querySelector('.i-19').value.toLowerCase();
  let out = document.querySelector('.out-19');
  for (key in a19) {
    for (item in a19[key]) {
      if (a19[key][item].toLowerCase() == val_inp) {
        out.textContent = key;
      }
    }
  }
