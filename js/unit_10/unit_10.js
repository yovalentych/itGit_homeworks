...
let ar1 = [1, 4, 66, 'one', 'two', true, 45, '+380693652285', false]; // переменную обьявляем здесь!!!!
...
let ar2 = [1, 4, 66, 'one', 'two', true, 45, '+380693652285', false]; // переменную обьявляем здесь!!!!
...
let ar3 = [1, 4, 66, 'one', 'two', true, 45, '+380693652285', false]; // переменную обьявляем здесь!!!!

function f3() {
  let output = document.querySelector('.out-3');
  output.innerHTML = ar3.length;
}
...
let ar4 = [1, 4, 66, 'one', 'two', true, 45, '+380693652285', false]; // переменную обьявляем эту здесь!!!!
let pos = [0, 3, 8];
function f4() {
...
function f19() {
  ...
  document.querySelector('.out-19').innerHTML = `${ind}`;
}
