...
function t11() {
  let input = document.querySelectorAll('.div-11');
  let counter = 0;
  let out = '';

  while (counter < input.length) {
    out += `${input[counter].innerHTML}_`;
    counter++;
  }
...
function t12() {
  let input = document.querySelectorAll('.div-12');
  let counter = 0;
  while (counter < input.length) {
    input[counter].style.background = 'orange';
    counter++;
  }
}
...
function t14() {
  ...
  let counter = 0;
  while (counter < input.length) {
    if (input[counter].checked) {
      document.querySelector('.out-14').innerHTML = input[counter].value;
    }
    counter++;
  }
}
...
function t15() {
  ...
  document.querySelector('.out-15').innerHTML = out.repeat(rep);
}
