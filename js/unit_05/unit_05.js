...
function t7() {
  let inputNum = document.querySelector('.i-7');
  let out = '';

  for (let i = inputNum.value; i >= 0; i--) {
    out += i + '_';
  }
...
function t8() {
  let inp_1 = document.querySelector('.i-81');
  let inp_2 = document.querySelector('.i-82');
  let out = '';

  for (let i = inp_1.value; i <= inp_2.value; i++) {
    out += i + '_';
  }
...
function t9() {
  let inp_1 = +document.querySelector('.i-91').value;
  let inp_2 = +document.querySelector('.i-92').value;
  let out = '';

  if (inp_1 <= inp_2) {
    for (let i = inp_1; i <= inp_2; i++) {
      out += i + '_';
    }
  } else {
    for (let i = inp_2; i <= inp_1; i++) {
      out += i + '_';
    }
  }
