...
function f6() {
  ...
  return (document.querySelector('.out-6').textContent = out);
}
...
function f8() {
  ...
  return (document.querySelector('.out-8').textContent = out);
}
...
function f9() {
  ...
  return (document.querySelector('.out-9').textContent = out);
}
...
function f10() {
  ...
  return (document.querySelector('.out-10').textContent = out);
}
...
function f11() {
  ...
  return (document.querySelector('.out-11').textContent = out);
}
...
function f12() {
  ...
  return (document.querySelector('.out-12').textContent = out);
}
