...
function t1() {
  ...
  try {
    ...
    return (document.querySelector('.out-1').textContent = 1);
  }
}
...
function t3() {
  ...
  try {
    ...
    const out3div = document.createElement('div');
    out3div.className = 'out-3';
    out3div.innerHTML = a * b;
    let buttonElement = document.querySelector('.b-3');
    buttonElement.insertAdjacentElement('afterend', out3div);
  }
}
