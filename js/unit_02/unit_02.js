...
let e1 = "3";
let f1 = 5;
document.querySelector(".out-4").textContent = e1 + f1; // це конкатенація, тому що 3 це строка.
...
function t9() {
  ...
  document.querySelector(".out-9").textContent = data9;
}
...
function t10() {
  ...
  document.querySelector(".out-10").textContent = data10 * 20;
}
...
function t11() {
  ...
  document.querySelector(".out-11").textContent = data11 + 55;
}
...
function t12() {
  ...
  document.querySelector(".out-12").innerHTML =
    "Hello " + inputName + " " + inputSurname;
}
// в заданні помилка i.12-1 и i.12-2, має бути через -  i-12-1 и i-12-2
...
function t15() {
  let borderStyle = (document.querySelector(".i-15").style.border =
    "4px solid red");
}
...
function t16() {
  let inputA = document.querySelector(".i-16-1").value;
  let inputB = document.querySelector(".i-16-2").value;

  document.querySelector(".out-16").innerHTML = inputA + inputB;
}
...
function t19() {
  let inputNum1 = +document.querySelector(".i-19-1").value;
  let inputNum2 = +document.querySelector(".i-19-2").value;

  document.querySelector(".out-19").textContent = inputNum1 + inputNum2;
}
